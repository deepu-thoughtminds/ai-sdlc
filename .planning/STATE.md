...
| 260702-pr5 | Merge PR #5 (Db-changes): delete ticket API + delete_for_ticket() on 4 repos (agent_event, pipeline_state, stage_transaction, ticket_status) | 2026-07-02 |
...
| 260629-lw | Create scripts/clear_db.py to drop all MongoDB collections with --yes flag | 2026-06-29 |
